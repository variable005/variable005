...
- 🎓 Dual Degree BCA–MCA @ Amity University Patna  
- 📱 Building apps in **Kotlin + Jetpack Compose**
- 🌐 Developing real-time **IoT systems with ESP32**
- 🛠 Hosting **tech workshops** & innovating in sustainable tech
- 🏁 Actively participating in **national & international hackathons**
...
### Tools & Technologies
<p>
  <img src="https://skillicons.dev/icons?i=androidstudio,arduino,raspberrypi,firebase,git,github,vscode" />
</p>
...
- 🔌 **ESP32 Wi-Fi Signal Dashboard** – Real-time web UI to monitor strength, uptime, and control devices  
- 🧠 **HectoClash** – Fast-paced mental math duel game with futuristic glassmorphism UI  
- 📱 **HEED (Rebuild)** – Accessibility app with speech-to-text & camera features  
- 🌍 **InnovateX Hackathon** – Organized tech hackathon under Techphilia 8.0
